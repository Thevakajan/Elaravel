...
class ManufactureController extends Controller
{
    ...
    //  echo "</pre>";
        ...
        Session::put('message', 'Menufacture add successfully');
    ...
    public function edit_manufacture($manufacture_id)
    {
        ...
        $category_info = DB::table('tbl_manufacture')
            ->where('manufacture_id', $manufacture_id)
            ->first();
        $category_info = view('admin.edit_manufacture')
            ->with('manufacture_info', $category_info);
        return view('admin_layout')
            ->with('admin.edit_manufacture', $category_info);
